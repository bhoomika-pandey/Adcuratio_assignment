...
for article in data:
    ...
    heading_collection.insert_one(
        {"heading": article["heading"], "url_id": url_id})
    metadata_collection.insert_one(
        {"img_url": article["img_url"], "title": article["title"], "upvote": article["upvote"], "url_id": url_id, "desc": article["desc"]})
